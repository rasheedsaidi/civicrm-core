 ...
 * @group headless
 */
class CRM_MembershipPeriod_MembershipContributionTest extends \PHPUnit_Framework_TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
  ...
  public function setUp() {
    ...
    $membership_period = CRM_Membershipperiod_civicrm_api3('MembershipPeriod', 'create', array(
      'contact_id' => $this->contact_id,
    ...
    $membership_contribution = civicrm_api3('Contribution')
    parent::setUp();
  }
